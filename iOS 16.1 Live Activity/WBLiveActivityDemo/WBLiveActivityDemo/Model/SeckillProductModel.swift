...
struct SeckillDataManager {
    static let seckillProductIds = "com.wb.seckillProductIds"
    ...
    static func getSeckillActivityId(productId: String) -> String? {
        if let ids = UserDefaults.standard.value(forKey: productId) as? [String: String] {
            return ids[productId]
        }
        return nil
    }
    
    func removeSeckillActivityId(productId: String) {
